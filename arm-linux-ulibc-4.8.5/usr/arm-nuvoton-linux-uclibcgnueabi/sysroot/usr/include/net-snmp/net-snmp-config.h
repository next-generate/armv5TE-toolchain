...
#define NETSNMP_CONFIGURE_OPTIONS " '--target=arm-nuvoton-linux-uclibcgnueabi' '--host=arm-nuvoton-linux-uclibcgnueabi' '--build=x86_64-pc-linux-gnu' '--prefix=/usr' '--exec-prefix=/usr' '--sysconfdir=/etc' '--localstatedir=/var' '--program-prefix=' '--disable-gtk-doc' '--disable-gtk-doc-html' '--disable-doc' '--disable-docs' '--disable-documentation' '--with-xmlto=no' '--with-fop=no' '--disable-dependency-tracking' '--enable-ipv6' '--disable-static' '--enable-shared' '--with-persistent-directory=/var/lib/snmp' '--with-defaults' '--enable-mini-agent' '--without-rpm' '--with-logfile=none' '--without-kmem-usage' '--enable-as-needed' '--without-perl-modules' '--disable-embedded-perl' '--disable-perl-cc-checks' '--disable-scripts' '--with-default-snmp-version=1' '--enable-silent-libtool' '--enable-mfd-rewrites' '--with-sys-contact=root@localhost' '--with-sys-location=Unknown' '--with-mib-modules=host ucd-snmp/dlmod agentx' '--with-out-mib-modules=disman/event disman/schedule utilities' '--with-out-transports=Unix' '--disable-manuals' '--with-endianness=little' '--with-openssl=/home/rick/rainbow/buildroot/NUC970_Buildroot/output/host/usr/arm-nuvoton-linux-uclibcgnueabi/sysroot/usr/include/openssl' '--with-security-modules=tsm,usm' '--with-transports=DTLSUDP,TLSTCP' '--disable-debugging' '--enable-agent' '--enable-applications' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=arm-nuvoton-linux-uclibcgnueabi' 'target_alias=arm-nuvoton-linux-uclibcgnueabi' 'CC=/home/rick/rainbow/buildroot/NUC970_Buildroot/output/host/usr/bin/arm-nuvoton-linux-uclibcgnueabi-gcc' 'CFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -Os ' 'LDFLAGS=' 'CPPFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64' 'CPP=/home/rick/rainbow/buildroot/NUC970_Buildroot/output/host/usr/bin/arm-nuvoton-linux-uclibcgnueabi-cpp'"
